...
struct ColMeta {
    ...
    friend bool operator==(const ColMeta &col1, const ColMeta &col2) {
        return col1.tab_name == col2.tab_name &&
               col1.name == col2.name;
    }

    friend bool operator==(const std::vector<ColMeta> &vec1, const std::vector<ColMeta> &vec2) {
