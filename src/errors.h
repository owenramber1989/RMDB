...
class NeedNewPageError : public RMDBError {
public:
    NeedNewPageError(const std::string &info) : RMDBError(info) {}
};
...
class InvalidDatetime : public RMDBError {
    public:
    InvalidDatetime() : RMDBError("Datetime is invalid") {}
};
