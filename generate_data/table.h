...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"warehouse.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"district.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"customer.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"history.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"new_orders.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"orders.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"order_line.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        outfile.close();
        write_data_into_file(file_name);
        std::cout<<"item.csv successfully loaded\n";
    }
...
public:
    ...
    void generate_data_csv(std::string file_name) {
        ...
        std::cout<<"stock.csv successfully loaded\n";
    }
