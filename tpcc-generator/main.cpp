...
int main(int argc, char **argv)
{
   // Check input
   if (argc != 2) {
      cout << "Usage: " << argv[0] << " <warehouse_count>" << endl;
      return -1;
   }
   ...
   std::string csv_path = "../src/test/performance_test/table_data";
   // Generate tpcc data
   TpccGenerator generator((uint32_t) warehouse_count, csv_path);
